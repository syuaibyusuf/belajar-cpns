...
<head>
    ...
    <title>Buat Paket Soal - Admin</title>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 ml-64 p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 max-w-2xl">
            <h1 class="text-2xl font-bold mb-6">📦 Buat Paket Soal Baru</h1>
            ...
            <form method="POST" action="{{ route('admin.packages.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" 
                           placeholder="Contoh: Try Out TWK 1, Latihan TIU Dasar" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Anda akan membuat soal satu per satu setelah ini</p>
                </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm text-yellow-800">
                            ...
                            <p>Setelah membuat paket, Anda akan diarahkan ke halaman <strong>Buat Soal</strong> untuk membuat {{ old('total_questions', 10) }} soal secara langsung.</p>
                            <p class="mt-1">Paket bisa disimpan sebagai DRAFT jika belum selesai, dan bisa dilanjutkan nanti.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3">
                    <button type="submit" class="bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600 transition">
                        <i class="fas fa-save mr-2"></i>Buat Paket & Lanjut Buat Soal
                    </button>
