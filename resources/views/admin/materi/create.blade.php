...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 ml-64 p-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('admin.materi.store') }}" enctype="multipart/form-data" id="materiForm">
                @csrf
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="order_number" value="0" class="w-32 px-4 py-2 border rounded-lg">
                        </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4">
                        <h3 class="font-semibold text-gray-800 mb-3">📷 Cara Menambahkan Gambar</h3>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <textarea name="content" id="contentTextarea" rows="15" class="w-full px-4 py-2 border rounded-lg font-mono text-sm" placeholder="Tulis materi di sini... Gunakan [IMAGE_0], [IMAGE_1], dll untuk menempatkan gambar"></textarea>
                </div>

                <div class="mb-4">
                    <button type="button" id="addImageBtn" class="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition">
                        <i class="fas fa-image mr-2"></i> Tambah Gambar
                    </button>
                </div>
